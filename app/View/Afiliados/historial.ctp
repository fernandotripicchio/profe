<div class="show_table">	
	...
	<table>
     ...
     <table>
      ...
      <table>
          <tr>
          	<td class="width-4 th_header" colspan="5"> Expedientes </td>
          </tr>
          <tr>
          	<td class="with-1"> ID				   </td>
          	<td class="with-2"> Tipo         	   </td>
          	<td class="with-2"> Urgente      	   </td>
          	<td class="with-2"> Expediente Tramix  </td>
          	<td class="with-2"> Fecha Inicio       </td>
          </tr> 
          <? foreach ($expedientes as $expediente) { ?>
            <tr>
            	<td><?php echo $this->html->link($expediente["Expediente"]["id"],array("controller"=>"expedientes", "action" => "show", $expediente["Expediente"]["id"] ), array());?></td>
             	<td><?php echo $expediente["TipoExpediente"]["nombre"] ?>    </td>
             	<td><?php echo ($expediente['Expediente']['urgente']==1 ? "Si" : "No" );   ?>  </td>
             	<td><?php echo $expediente["Expediente"]["nro_expediente_tramix"]; ?>    </td>
